...
const Button = (props: IButton) => {
    const classes = [`AMB-Checkbox ${props.loading && 'loading'} ${props.primary && 'primary'} ${props.outlined && 'outlined'}`, props.className].join(' ').trim();
    const disabled = props.hasOwnProperty('disabled') ? props.disabled : true;
    const spinner = props.spinner ? props.spinner : '';
